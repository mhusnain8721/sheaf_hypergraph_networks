...
class dataset_Hypergraph(InMemoryDataset):
    def __init__(self, root = './data/pyg_data/hypergraph_dataset_updated/', name = None, 
        ...
        existing_dataset = ['20newsW100', 'ModelNet40', 'zoo', 
                            ...
                            'synthetic-1-100','synthetic-2-100','synthetic-3-100','synthetic-4-100',
                            'synthetic-5-100','synthetic-6-100','synthetic-7-100', 
    ...
    def download(self):
        for name in self.raw_file_names:
            ...
            if not osp.isfile(p2f):
                ...
                elif self.name in ['amazon-reviews', 'walmart-trips', 'house-committees', 'senate-committees', 'congress-bills', 'synthetic-1', 'synthetic-2', 'synthetic-3', 'synthetic-4', 'synthetic-5', 'synthetic-6', 'synthetic-7']:
